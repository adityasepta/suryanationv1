        ...
        datasets: [
            {
                ...
                pointBorderColor: ["rgba(0,0,255,1)","rgba(0,0,255,1)","rgba(0,0,255,1)","rgba(0,0,255,1)","rgba(0,0,255,1)"],
                borderColor: ["rgba(0,0,255,1)"],
                pointHoverBackgroundColor: ['rgba(0,0,255,0.5)','rgba(0,0,255,0.5)','rgba(0,0,255,0.5)','rgba(0,0,255,0.5)','rgba(0,0,255,0.5)'],
            ...
            },
            {
                ...
                pointBorderColor: ["rgba(255,0,0,1)","rgba(255,0,0,1)","rgba(255,0,0,1)","rgba(255,0,0,1)","rgba(255,0,0,1)"],
                borderColor: ["rgba(255,0,0,1)"],
                pointHoverBackgroundColor: ['rgba(255,0,0,0.5)','rgba(255,0,0,0.5)','rgba(255,0,0,0.5)','rgba(255,0,0,0.5)','rgba(255,0,0,0.5)'],
