...
<body>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            ...
                            <input type="hidden" name="jenisTempahan" value="pertokoan" class="form-control">
    ...
    <script type="text/javascript">
            function calc(){
                    ...
                    var prosentase = parseFloat(document.getElementById('prosentase').value);
                    var hargaAkhir = parseFloat(document.getElementById('hargaAkhir').value);

                            var berathargaAkhir = beratAkhir*hargaAkhir*(prosentase/100);
                    ...
                    var beratDatangBerlian = parseFloat(document.getElementById('beratDatangBerlian').value);
                    ...
                    var jumlahDatangBerlian = parseFloat(document.getElementById('jumlahDatangBerlian').value);
                            ...
                            var upahBerlian = upahPasangBerlian*jumlahDatangBerlian*beratDatangBerlian;
                            var upahBerlianText = formatNumber(upahBerlian);
                    document.getElementById('upahBerlian').value = upahBerlian;
                    document.getElementById('upahBerlianText').value = upahBerlianText;
