                                ...
                                <tbody>
                                     <?php for ($j=0; $j < count($spk); $j++) { ?>
                                            <tr>
                                                ...
                                                for ($z=0; $z < count($b) ; ++$z) { 
                                                    if($b[$z]->idSPK == $spk[$j]->idSPK) {
                                                        if((int)$b[$z]->idAktivitas == 1006) { 
                                                            $ii=1;$bAwal=$bAwal+$b[$z]->berat;
                                                        }
                                                        if((int)$b[$z]->idAktivitas == 1014) { 
                                                            $oo=1;$bAkhir=$bAkhir+$b[$z]->berat;
                                                        }
                                                ...
                                                <td class="text-center">
                                                    <?php if ($spk[$j]->statusSPK=='On progress') { $prosenHilang='-';}?>
                                                    <?php if ($prosenHilang!='-') { 
                                                    if ($prosenHilang2 <= 3) { 
                                            ...
                                            <div class="tabs-container">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a data-toggle="tab" href="#tab-2-<?php echo $p->idSPK?>">Detail Berat Per Aktivitas</a></li>
                                                     <li><a data-toggle="tab" href="#tab-1-<?php echo $p->idSPK?>">Detail Berat Per PIC</a></li>
                                                </ul>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>  
                                                                        <td class="text-center">Berat <?php echo $b[$z]->namaAktivitas ?></td>
                                                                            <?php  if ($b[$z]->namaAktivitas == 'Cor' && $b[$z]->berat) {
                                                ...
                                                <div id="tab-1-<?php echo $p->idSPK ?>" class="tab-pane">
                                                        <div class="panel-body">
                                                            <div class="row">
                                                            <table class="table table-hover table-responsive">
                                                                <thead>
                                                                    <tr>
                                                                        <th class="text-center">Sub SPK</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php for ($z=0; $z < count($c) ; ++$z) { 
                                                                        if($c[$z]->idSPK == $p->idSPK) {
                                                                            if($c[$z]->berat) {
                                                                    ?>
                                                                    <tr>  
                                                                        <td class="text-center"><?php echo $c[$z]->idSubSPK ?></td>
                                                                        <td class="text-center"><?php echo $c[$z]->idWadah ?></td>
                                                                        <td class="text-center">Berat <?php echo $c[$z]->namaAktivitas ?></td>
                                                                            <?php  if ($c[$z]->namaAktivitas == 'Cor' && $c[$z]->berat) {
                                                                            ...
                                                                            <?php } else if ($c[$z]->namaAktivitas != 'Selesai' && $c[$z]->berat) { 
                                                                                ...
                                                                                <?php } else { ?>
                                                                                    <td class="text-center"><?php echo '<small class="label label-danger">LOSS</small>' ?></td>
                                                                                <?php } ?>
                                                                            <?php } else if ($c[$z]->namaAktivitas != 'Selesai' && !$c[$z+1]->berat) { ?>
                                                                                <td class="text-center">-</td>
                                                                                <td class="text-center">-</td>
                                                                                <td class="text-center">-</td>
                                                                                <td class="text-center">-</td>
                                                                            ...
                                                                            <?php } else {?>
                                                                                ...
                                                                                <td class="text-center"><?php echo '<small class="label label-primary">DONE</small>' ?></td>
                                                                            <?php } ?>
                                                                            <td class="text-center"><?php echo $c[$z]->nama ?></td>
                                                                    </tr>
                                                                    <?php } else { ?>
                                                                        <tr>
                                                                            <td class="text-center"><?php echo $c[$z]->idSubSPK ?></td>
