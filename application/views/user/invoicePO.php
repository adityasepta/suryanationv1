        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong><a href="<?php echo base_url();?>user/Invoice">Form Order</a></strong>
                    </li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="m-b-md">
                                        <a href="<?php echo base_url()?>user/printInvoice/<?php echo $nomorPO?>" class="btn btn-primary btn-xs pull-right"><i class="fa fa-print"></i> Print Form Order</a>
                                ...
                                <div class="tab-pane" id="tab-2">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <label> <?php if($jumlahDatangBerlian==NULL || $jumlahDatangBerlian==0){echo 0;} else { echo $jumlahDatangBerlian;}?> Pcs</label>
                                            </td>
                                            <td>
