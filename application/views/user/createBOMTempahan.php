                ...
                <div class="col-lg-4">
                    <div class="ibox float-e-margins">
                        ...
                        <script type="text/javascript">
                            ...
                            var t = <?php echo $kloter[0]->kadarBahan ?>;
                            var c = 0;

                            <?php for($i = 0; $i < count($kloter); ++$i) {?>
                                c += <?php echo $kloter[$i]->beratAkhir ?>;
                            <?php } ?>
                        ...
                        <div class="ibox-content form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <input type="number" step="any" required name="kadar" class="form-control" value="<?php echo $spk[0]->kadarWenny ?>" id="Wenny" > 
                                     <script type="text/javascript">
                                ...
                                <div class="col-sm-4">
                                    <br>
                                    <?php if($spk[0]->kadarWenny == 0 ) { ?>
                                        <b class="text-danger">Belum Konfirmasi Kadar</b>
                                    <?php } else { ?>
                                        <b>Kadar telah dikonfirmasi sebesar <?php echo $spk[0]->kadarWenny ?></b>
                                    <?php } ?>
                                </div>
                                <?php echo form_close()?>
                            ...
                            <div class="row">
                                 <div class="col-lg-10 text-right">
                                    <b class="text-danger pull-left">Jangan lupa konfirmasi kadar !</b>
                                    <button data-toggle="modal" data-target="#spk" class="btn btn-default">Daftar SPK</button>
                            ...
                            <div class="modal inmodal fade" id="spk" tabindex="-1" role="dialog"  aria-hidden="true">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><a class="btn btn-info btn-xs" href="<?php echo base_url('user/invoice/'.$spk[$i]->nomorFaktur); ?>">Detil SPK</a></td>
                                                    </tr>
