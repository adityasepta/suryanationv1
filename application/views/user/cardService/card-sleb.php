...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
            <a href="<?php echo base_url('User/next/'.$sl[$i]->idProduk.'/'.$sl[$i]->idAktivitas.'/'.$sl[$i]->idProProd.'/'.$sl[$i]->idSPK)?>" onclick="return confirm('Apakah anda yakin untuk melanjutkan aktivitas produksi nomor faktur <?php echo $sl[$i]->nomorFaktur ?>?')"  class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-right"></span></a>
            <?php } ?>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-center">
                            Kembalian Berat<br>
                            <b><?php echo $sl[$i]->kembali ?> gr</b><br><br>
                            Tanggal Mulai<br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <!-- <span >NO PO : <b class="text-success"><?php echo $sl[$i]->nomorPO ?></b> | TIPE : <b class="text-success"><?php echo $sl[$i]->tipeOrder ?></b></span><br> -->
   ...
   <!--                  <h2><span class="fa fa-warning text-danger"></span>
                                        ...
                                        <table class="table table-hover table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ((int)$b[$z]->idAktivitas == 1009) { ?>
                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <a href="<?php echo base_url('user/invoicePOService/'.$sl[$i]->nomorPO) ?>" type="button" class="btn btn-default btn-outline ">Detail PO</a>
                            <a href="<?php echo base_url('user/invoicePOService/'.$sl[$i]->nomorFaktur) ?>" type="button" class="btn btn-default btn-outline ">Detail SPK</a>
