...
<li class="<?php echo $statr ?>-element" id="task1">
    <div class="row">
        <div class="col-lg-4 text-center">
            No PO<br>
            <b><?php echo $po[$i]->nomorPO ?></b>
        </div>
        <div class="col-lg-4 text-center">
            No Faktur<br>
            <b><?php echo $po[$i]->nomorFaktur ?></b>
        </div>
        <div class="col-lg-4 text-center ">
            Tipe Order<br>
            <b><?php echo $po[$i]->tipeOrder ?></b>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            :&nbsp&nbsp<b><?php echo $po[$i]->namaPIC ?></b>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <br>    
            <button data-toggle="modal" data-target="#detail<?php echo $po[$i]->nomorFaktur ?>" class="btn btn-xs btn-default btn-block">Detail</button>
        </div>
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
                <?php if($po[$i]->statusBerat == 'Belum Disetujui') {?>
                 ...
                 <button data-toggle="modal" data-target="#serah<?php echo $po[$i]->nomorFaktur ?>" class="btn btn-xs btn-success btn-block"><span class="fa fa-check"></span></button>
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
            <a href="<?php echo base_url('User/next/'.$po[$i]->idProduk.'/'.$po[$i]->idAktivitas.'/'.$po[$i]->idProProd.'/'.$po[$i]->idSPK)?>" onclick="return confirm('Apakah anda yakin untuk melanjutkan aktivitas produksi nomor faktur <?php echo $po[$i]->nomorFaktur ?>?')"  class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-right"></span></a>
            <?php } ?>
        </div>
        
    </div>

    <div class="modal inmodal fade" id="serah<?php echo $po[$i]->nomorFaktur ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6 text-center">
                            Asal Aktivitas<br>
                            <h1 class="text-success">Polish</h1>
                        </div>
                        ...
                        <div class="col-lg-3 text-center">
                            Kembalian Berat<br>
                            <b><?php echo $po[$i]->kembali ?> gr</b><br><br>
                            Tanggal Mulai<br>
    ...
    <div class="modal inmodal fade" id="detail<?php echo $po[$i]->nomorFaktur ?>" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    ...
                    <!-- <span >NO PO : <b class="text-success"><?php echo $po[$i]->nomorPO ?></b> | TIPE : <b class="text-success"><?php echo $po[$i]->tipeOrder ?></b></span><br> -->
   ...
   <!--                  <h2><span class="fa fa-warning text-danger"></span>
                ...
                <div class="modal-body">
                    ...
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#tab-1<?php echo $po[$i]->nomorFaktur ?>">Informasi Umum</a></li>
                            <li class=""><a data-toggle="tab" href="#tab-2<?php echo $po[$i]->nomorFaktur ?>">Jadwal</a></li>
                            <li class=""><a data-toggle="tab" href="#tab-3<?php echo $po[$i]->nomorFaktur ?>">Berat</a></li>
                        </ul>
                        <div class="tab-content">
                            <div id="tab-1<?php echo $po[$i]->nomorFaktur ?>" class="tab-pane active">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 text-center">
                                            ...
                                            <img src="<?php echo base_url('uploads/gambarProduk/'.$po[$i]->kodeGambar.'-cust.jpg')?>" class="img-responsive">
                                        </div>
                                        <div class="col-lg-4 text-center">
                                            <b>Foto 3D Model</b><br><br>
                                            <?php if($po[$i]->statusDesain !== 'Proses Desain') {?>
                                            <img src="<?php echo base_url('uploads/gambarDesain/'.$po[$i]->kodeGambar.'-d1.jpg')?>" class="img-responsive">
                                            <?php } ?>
                                        </div>
                                        <div class="col-lg-4 text-center">
                                            <b>Foto PIC</b><br><br>
                            ...
                            <div id="tab-2<?php echo $po[$i]->nomorFaktur ?>" class="tab-pane">
                                <div class="panel-body">
                            ...
                            <div id="tab-3<?php echo $po[$i]->nomorFaktur ?>" class="tab-pane">
                                <div class="panel-body">
                                    <div class="row">
                                        <table class="table table-hover table-responsive">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  class="text-center"><button data-toggle="modal"  data-dismiss="modal" data-target="#<?php echo $b[$z]->idAktivitas ?><?php echo $po[$i]->idSPK ?>" class="btn btn-xs btn-info ">Update Berat</button></td>

                                                    <?php } else { ?>

                                                    <td  class="text-center"><button data-toggle="modal" disabled data-dismiss="modal" data-target="#<?php echo $b[$z]->idAktivitas ?><?php echo $po[$i]->idSPK ?>" class="btn btn-xs btn-info ">Update Berat</button></td>

                                                    <?php } ?>

                                                    <div class="modal inmodal fade" id="<?php echo $b[$z]->idAktivitas ?><?php echo $po[$i]->idSPK ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <button data-toggle="modal" data-dismiss="modal" data-target="#detail<?php echo $po[$i]->nomorFaktur ?>" class="btn btn-danger btn-block">Kembali</button>
                                                                        </div>
                                                                        <div class="col-lg-6">
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col-lg-5">
                            <button data-toggle="modal" data-dismiss="modal" data-target="#pic<?php echo $po[$i]->nomorFaktur ?>"  class="btn btn-info btn-block btn-outline">Tambah PIC</button>

                            <div class="modal inmodal fade" id="pic<?php echo $po[$i]->nomorFaktur ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body">
                        ...
                        <div class="col-lg-7">
                            <a href="<?php echo base_url('user/invoicePOService/'.$po[$i]->nomorPO) ?>" type="button" class="btn btn-default btn-outline ">Detail PO</a>
                            <a href="<?php echo base_url('user/invoicePOService/'.$po[$i]->nomorFaktur) ?>" type="button" class="btn btn-default btn-outline ">Detail SPK</a>
