...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <?php } else if($gp[$i]->statusWork == 'On Progress' AND $gp[$i]->statusBerat == 'Disetujui' ) { ?>                
                <a  data-toggle="modal" data-target="#akt<?php echo $gp[$i]->idProProd ?>" class="btn btn-xs btn-success btn-block">Lanjut Aktivitas</a>
            <?php } ?>
        </div>
    ...
    <div class="modal inmodal fade" id="detail<?php echo $gp[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-5 control-label">Berat Akhir <?php echo $namakt ?></label>
                                        ...
                                        <div class="col-sm-2"><input type="hidden"  name="idProProd"  value="<?php echo $gp[$i]->idProProd ?>"></div>
                                    </div>
                                </div>
                                
                               <div class="row">
                                    <div class="col-lg-6">
                                        <button data-toggle="modal" data-dismiss="modal" data-target="#berat<?php echo $gp[$i]->idProProd ?>" class="btn btn-danger btn-block">Kembali</button>
                                    </div>
                                    <div class="col-lg-6">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group"><label class="col-sm-3 control-label">Pilih / Ubah PIC</label>
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" value="<?php echo $gp[$i]->beratAwal?>" name="beratAwal">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-3 control-label">Password PIC</label>
                                        ...
                                        <div class="col-sm-4">
                                            <input type="password" id="<?php echo $gp[$i]->idProProd?>-dreasing?>-password-2" required  value="0" name="password2" class="form-control">
                                            <input type="hidden" id="<?php echo $gp[$i]->idProProd?>-dreasing?>-password-1" required value="0" name="password">
                                        </div>
                                        <div class="col-sm-2">
                                            <button type="button" onclick="cekdreasing<?php echo $gp[$i]->idProProd?>();" class="btn btn-sm btn-primary btn-block">Cek</button>
                                        </div>
                                ...
                                <div class="form-horizontal" >
                                    <div class="form-group">
                                    <div class="col-lg-12 text-center" id='<?php echo $gp[$i]->idProProd?>-dreasing?>-cek' style="display: none;">
                                        Password tidak cocok. Silahkan coba lagi.
                                    </div>
                                    <div class="col-lg-12 text-center" id='<?php echo $gp[$i]->idProProd?>-dreasing?>-cek1' style="display: none;">
                                        Password valid.
                                    </div>
                                     </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <button type="submit" id="<?php echo $gp[$i]->idProProd?>-dreasing" disabled="true"  class="btn btn-block btn-success">Simpan</button>
                                </div>
                            </div>
                            <?php echo form_close() ?>
                        </div>
            ...
            <div class="modal inmodal fade" id="akt<?php echo $gp[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" value="<?php echo $gp[$i]->idProProd?>" name="idProProd">
                                            <input type="hidden" class="form-control" value="<?php echo $gp[$i]->idSPK?>" name="idSPK">
        ...
        function passing<?php echo $gp[$i]->idProProd ?>() {
            ...
            $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("input[id='<?php echo $gp[$i]->idProProd?>-dreasing?>-password-1']").val(Vals[0].password);
                    }
            });
        }
</script>
<script type="text/javascript">
        function cekdreasing<?php echo $gp[$i]->idProProd?>() {
            var password = document.getElementById('<?php echo $gp[$i]->idProProd ?>-dreasing?>-password-1').value;
            var password2 = document.getElementById('<?php echo $gp[$i]->idProProd ?>-dreasing?>-password-2').value;
            console.log(password);
            console.log(password2);
            var x = document.getElementById("<?php echo $gp[$i]->idProProd ?>-dreasing?>-cek");
            var y = document.getElementById("<?php echo $gp[$i]->idProProd ?>-dreasing?>-cek1");

            if(password==password2) {
                $('#<?php echo $gp[$i]->idProProd ?>-dreasing').prop('disabled', false);
                x.style.display = "none";
                y.style.display = "block";
            }
            else {
                $('#<?php echo $gp[$i]->idProProd ?>-dreasing').prop('disabled', true);
