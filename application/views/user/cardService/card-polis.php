...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
                <?php if($gi[$i]->statusBerat == 'Belum Disetujui') {?>
                 <button data-toggle="modal" data-target="#serah<?php echo $gi[$i]->nomorFaktur ?>" class="btn btn-xs btn-success btn-block"><span class="fa fa-check"></span></button>
                <?php } else {?>
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
            <a href="<?php echo base_url('User/nextService/'.$gi[$i]->idAktivitas.'/'.$gi[$i]->idProProd.'/'.$gi[$i]->idSPK)?>" onclick="return confirm('Apakah anda yakin untuk melanjutkan aktivitas produksi nomor faktur <?php echo $gi[$i]->nomorFaktur ?>?')"  class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-right"></span></a>
            <?php } ?>
        </div>
        
    </div>

    <div class="modal inmodal fade" id="serah<?php echo $gi[$i]->nomorFaktur ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6 text-center">
                            Asal Aktivitas<br>
                            <h1 class="text-success">Polis + Cuci</h1>
                        </div>
   ...
   <!--                  <h2><span class="fa fa-warning text-danger"></span>
                                        ...
                                        <table class="table table-hover table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ((int)$b[$z]->idAktivitas == 1002) { ?>
                                                    ...
                                                    <?php } ?>
                                                    <div class="modal inmodal fade" id="<?php echo $b[$z]->idAktivitas ?><?php echo $gi[$i]->idSPK ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <a href="<?php echo base_url('user/invoicePOService/'.$gi[$i]->nomorPO) ?>" type="button" class="btn btn-default btn-outline ">Detail PO</a>
                            <a href="<?php echo base_url('user/invoicePOService/'.$gi[$i]->nomorFaktur) ?>" type="button" class="btn btn-default btn-outline ">Detail SPK</a>
