...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <?php if ($gi[$i]->statusWork == 'Belum ada PIC') { ?>
                <button data-toggle="modal" data-target="#pic<?php echo $gi[$i]->idProProd ?>"  class="btn btn-xs btn-success btn-block" onclick="tambahpic<?php echo $gi[$i]->idProProd ?>();">Tambah PIC</button>
            <?php } else if($gi[$i]->statusWork == 'On Progress' AND $gi[$i]->berat == 0 ) {  ?>
                <button data-toggle="modal" data-dismiss="modal" data-target="#berat<?php echo $gi[$i]->idProProd ?>"  class="btn btn-xs btn-success btn-block">Tambah Berat</button>
            <?php } else if($gi[$i]->statusWork == 'On Progress' AND $gi[$i]->berat > 0 AND $gi[$i]->statusBerat == 'Belum Disetujui' ) { ?>                
                <button data-toggle="modal" data-target="#serah<?php echo $gi[$i]->idProProd ?>" class="btn btn-xs btn-success btn-block">Validasi Berat</button>
            <?php } else if($gi[$i]->statusWork == 'On Progress' AND $gi[$i]->statusBerat == 'Disetujui' ) { ?>                
                <a  data-toggle="modal" data-target="#akt<?php echo $gi[$i]->idProProd ?>" class="btn btn-xs btn-success btn-block">Lanjut Aktivitas</a>
            <?php } ?>
        </div>

    </div>

    <div class="modal inmodal fade" id="serah<?php echo $gi[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-center">
                            Berat Akhir<br>
                            <b><?php echo $gi[$i]->berat ?> gr</b><br><br>
                            PIC Proses<br>
                            <b><?php echo $gi[$i]->namaPIC ?></b>
                        </div>
                        <div class="col-lg-3 text-center">
                            Tanggal Mulai<br>
                            <b><?php echo $gi[$i]->tglmulai ?></b>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <br><br>
                            <a href="<?php echo base_url('User/approveService/'.$gi[$i]->idProProd) ?>" onclick="return confirm('Apakah anda yakin untuk menyetujui berat dari aktivitas produksi nomor faktur <?php echo $gi[$i]->nomorFaktur ?>?')"  class="btn btn-lg btn-primary btn-block">Validasi</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal inmodal fade" id="detail<?php echo $gi[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal inmodal fade" id="berat<?php echo $gi[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-5 control-label">Berat Awal <?php echo $namakt ?></label>
                                        ...
                                        <div class="col-sm-5"><input type="number" step="any" name="beratAwal" readonly="" value="<?php echo $gi[$i]->beratAwal?>" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-5 control-label">Berat Akhir <?php echo $namakt ?></label>
                                        ...
                                        <div class="col-sm-2"><input type="hidden"  name="idProProd"  value="<?php echo $gi[$i]->idProProd ?>"></div>
                                    </div>
                                </div>
                                
                               <div class="row">
                                    <div class="col-lg-6">
                                        <button data-toggle="modal" data-dismiss="modal" data-target="#berat<?php echo $gi[$i]->idProProd ?>" class="btn btn-danger btn-block">Kembali</button>
                                    </div>
                                    <div class="col-lg-6">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <?php echo form_open('User/setPICService2')?>
                            <div class="form-horizontal">
                                ...
                                <div class="form-group"><label class="col-sm-3 control-label">Pilih / Ubah PIC</label>
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        $js = array( 'class' => 'form-control', 'onchange' => 'passing'.$gi[$i]->idProProd.'()', 'id' =>  $gi[$i]->idProProd."-pic");
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" value="<?php echo $gi[$i]->beratAwal?>" name="beratAwal">
                                            <input type="hidden" class="form-control" value="<?php echo $gi[$i]->beratAwal?>" name="berat">
                                        </div>
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-3 control-label">Password PIC</label>
                                        ...
                                        <div class="col-sm-4">
                                            <input type="password" id="<?php echo $gi[$i]->idProProd?>-polish?>-password-2" required  value="0" name="password2" class="form-control">
                                            <input type="hidden" id="<?php echo $gi[$i]->idProProd?>-polish?>-password-1" required value="0" name="password">
                                        </div>
                                        <div class="col-sm-2">
                                            <button type="button" onclick="cekpolish<?php echo $gi[$i]->idProProd?>();" class="btn btn-sm btn-primary btn-block">Cek</button>
                                        </div>
                                ...
                                <div class="form-horizontal" >
                                    <div class="form-group">
                                    <div class="col-lg-12 text-center" id='<?php echo $gi[$i]->idProProd?>-polish?>-cek' style="display: none;">
                                        Password tidak cocok. Silahkan coba lagi.
                                    </div>
                                    <div class="col-lg-12 text-center" id='<?php echo $gi[$i]->idProProd?>-polish?>-cek1' style="display: none;">
                                        Password valid.
                                    </div>
                                     </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <button type="submit" id="<?php echo $gi[$i]->idProProd?>-polish" disabled="true"  class="btn btn-block btn-success">Simpan</button>
                                </div>
                            </div>
                            <?php echo form_close() ?>
                        </div>
            ...
            <div class="modal inmodal fade" id="akt<?php echo $gi[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <?php for ($k=0; $k < count($akt) ; $k++) { 
                                            if($akt[$k]->idSPK == $gi[$i]->idSPK and $akt[$k]->idAktivitas > $idakt) { ?>
                                    ...
                                    <input type="hidden" class="form-control" value="<?php echo $gi[$i]->idProProd?>" name="idProProd">
                                            <input type="hidden" class="form-control" value="<?php echo $gi[$i]->idSPK?>" name="idSPK">
...
<script type="text/javascript">
        function tambahpic<?php echo $gi[$i]->idProProd ?>() {
            passing<?php echo $gi[$i]->idProProd ?>();
        };

        function passing<?php echo $gi[$i]->idProProd ?>() {
            var pic = document.getElementById('<?php echo $gi[$i]->idProProd ?>-pic');
            ...
            $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("input[id='<?php echo $gi[$i]->idProProd?>-polish?>-password-1']").val(Vals[0].password);
                    }
            });
        }
</script>
<script type="text/javascript">
        function cekpolish<?php echo $gi[$i]->idProProd?>() {
            var password = document.getElementById('<?php echo $gi[$i]->idProProd ?>-polish?>-password-1').value;
            var password2 = document.getElementById('<?php echo $gi[$i]->idProProd ?>-polish?>-password-2').value;
            console.log(password);
            console.log(password2);
            var x = document.getElementById("<?php echo $gi[$i]->idProProd ?>-polish?>-cek");
            var y = document.getElementById("<?php echo $gi[$i]->idProProd ?>-polish?>-cek1");

            if(password==password2) {
                $('#<?php echo $gi[$i]->idProProd ?>-polish').prop('disabled', false);
                x.style.display = "none";
                y.style.display = "block";
            }
            else {
                $('#<?php echo $gi[$i]->idProProd ?>-polish').prop('disabled', true);
