            ...
            <div class="modal-content">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 text-center">
                                            ...
                                            <img src="<?php echo base_url('uploads/gambarProduk/'.$sp2[$i]->kodeGambar.'-cust.jpg')?>" class="img-responsive">
                                        </div>
                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <a href="<?php echo base_url('user/invoicePO/'.$sp2[$i]->nomorPO) ?>" type="button" class="btn btn-default btn-outline ">Detail PO</a>
                            <a href="<?php echo base_url('user/invoiceMassal/'.$sp2[$i]->nomorFaktur) ?>" type="button" class="btn btn-default btn-outline ">Detail SPK</a>
