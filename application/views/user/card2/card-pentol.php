    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php if($gp[$i]->statusWork == 'On Progress' AND $gp[$i]->statusBerat == 'Disetujui') { ?>
                ...
                <a href="<?php echo base_url('User/next3/'.$gp[$i]->idProduk.'/'.$idakt.'/'.$gp[$i]->idProProd.'/'.$gp[$i]->idSPK.'/'.$gp[$i]->idSubSPK.'/'.$gp[$i]->idWadah)?>" onclick="return confirm('Apakah anda yakin untuk melanjutkan aktivitas produksi nomor faktur <?php echo $gp[$i]->nomorFaktur ?>?')"  class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-right"></span></a>
                                        ...
                                        <table class="table table-hover table-responsive">
                                            ...
                                            <tbody>
                                                <?php for ($j=0; $j < count($b) ; $j++) { 
                                                    if($b[$j]->idSubSPK == $gp[$i]->idSubSPK and $b[$j]->idAktivitas == '1006') { ?>
                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            <a href="<?php echo base_url('user/invoiceMassal/'.$gp[$i]->nomorFaktur) ?>" type="button" class="btn btn-default btn-outline ">Detail SPK</a>
