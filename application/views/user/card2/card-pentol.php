                                ...
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-3 control-label">Berat Awal</label>
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <small>jumlah maksimal adalah <b><?php echo (float)$gp[$i]->beratAwal?></b> gr</small>  
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group"><label class="col-sm-3 control-label">Berat Tambahan</label>
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="number" step="any" name="beratTambahan" value="<?php echo $gp[$i]->beratTambahan?>" required class="form-control">
