...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php if($po[$i]->statusWork == 'On Progress' AND $po[$i]->statusBerat == 'Disetujui') { ?>
        
                

                <a href="<?php echo base_url('User/next3/'.$po[$i]->idProduk.'/'.$idakt.'/'.$po[$i]->idProProd.'/'.$po[$i]->idSPK.'/'.$po[$i]->idSubSPK.'/'.$po[$i]->idWadah)?>" onclick="return confirm('Apakah anda yakin untuk melanjutkan aktivitas produksi nomor faktur <?php echo $po[$i]->nomorFaktur ?>?')"  class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-right"></span></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <span >NO FAKTUR : <b class="text-success"><?php echo $po[$i]->nomorFaktur ?></b> | ID SUB SPK : <b class="text-success"><?php echo $po[$i]->idSubSPK ?></b>| ID Wadah : <b class="text-success"><?php echo $po[$i]->idWadah ?></b></span><br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            ...
                            <li class=""><a data-toggle="tab" href="#tab-3<?php echo $po[$i]->idProProd ?>">Berat</a></li>
                        </ul>
                        <div class="tab-content">
                                    ...
                                    <table class="table table-hover table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Penjadwalan</td>
                                                <td class="text-center"><?php echo $po[$i]->tanggaljadwal?></td>
                                                <td class="text-center"><label class="label label-xs label-primary">Diterima</label></td>
                                            </tr>
                            ...
                            <div id="tab-3<?php echo $po[$i]->idProProd ?>" class="tab-pane">
                                <div class="panel-body">
                                    <div class="row">
                                        <table class="table table-hover table-responsive">
                                            <thead>
                                            ...
                                            <tbody>
                                                <?php for ($j=0; $j < count($b) ; $j++) { 
                                                    if($b[$j]->idSubSPK == $po[$i]->idSubSPK and $b[$j]->idAktivitas == '1006') { ?>
                                                ...
                                                <?php }
                                                    if($b[$j]->idWadah == $po[$i]->idWadah and $b[$j]->idAktivitas > 1006) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                                ...
                                                                <button data-toggle="modal"  data-dismiss="modal" data-target="#<?php echo $b[$j]->idAktivitas ?><?php echo $po[$i]->idProProd ?>" class="btn btn-xs btn-info">Update Berat</button>
                                                                ...
                                                                <div class="modal inmodal fade" id="<?php echo $b[$j]->idAktivitas ?><?php echo $po[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col-lg-5">
                            <button data-toggle="modal" data-dismiss="modal" data-target="#pic<?php echo $po[$i]->idProProd ?>"  class="btn btn-info btn-block btn-outline">Tambah PIC</button>
                        ...
                        <div class="col-lg-7">
                            ...
                            <a href="<?php echo base_url('user/invoiceMassal/'.$po[$i]->nomorFaktur) ?>" type="button" class="btn btn-default btn-outline ">Detail SPK</a>
