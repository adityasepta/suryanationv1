...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        <div class="col-lg-12 text-center ">
            ...
            <b class="pull-right "><?php echo $po[$i]->nomorFaktur ?> - <?php echo $po[$i]->idSubSPK ?> - <?php echo $po[$i]->idWadah ?> | <?php echo $po[$i]->jumlahNow ?> / <?php echo $po[$i]->jumlah ?></b>
        </div>
        <div class="col-lg-12 text-center ">
            <span class="pull-left">Nama</span>
            <b class="pull-right"><?php echo $po[$i]->namaCustomer ?></b>
        </div>
        <div class="col-lg-12 text-center ">
            <span class="pull-left">Produk</span>
            <b class="pull-right"><?php echo $po[$i]->namaProduk ?></b>
        </div>
        <div class="col-lg-12 text-center ">
            <span class="pull-left">PIC</span>
            <b class="pull-right"><?php echo $po[$i]->namapic ?></b>
        </div>
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                :&nbsp&nbsp<b><?php echo $po[$i]->nomorFaktur ?></b><br>
                :&nbsp&nbsp<b><?php echo $po[$i]->namaCustomer ?></b><br>
                :&nbsp&nbsp<b><?php echo $po[$i]->namasales ?></b>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                :&nbsp&nbsp<b><?php echo $po[$i]->namap ?></b><br>
                :&nbsp&nbsp<b><?php echo substr($po[$i]->model,0,18)?></b>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                :&nbsp&nbsp<b><?php echo $po[$i]->kadarBahan ?> %</b>
        ...
        <div class="row">
            <div class="col-lg-6 text-center">
                Tgl Masuk<br>
                <b><?php echo $po[$i]->tanggal ?></b>
            </div>

            <div class="col-lg-6 text-center ">
                Tgl Estimasi Selesai<br>
                <b><?php echo $po[$i]->tanggalSelesai ?></b>
            </div>
        </div>
        <br>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <button data-toggle="modal" data-target="#kasih<?php echo $po[$i]->idProProd ?>" class="btn btn-xs btn-success btn-block">Lanjut Aktivitas</button>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select id="<?php echo $po[$i]->idProProd ?>-akt" required class="form-control" name="idAktivitas2">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-3 control-label">Berat Awal</label>
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <small>berat maksimal adalah <b><?php echo ((float)$po[$i]->beratAwal-(float)$po[$i]->berat)+(float)$po[$i]->beratTambahan?></b> gr</small>  
                                        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-9 text-center">
                            ...
                            <h1 id="<?php echo $po[$i]->idProProd ?>-akt-d" class="text-success"></h1>
                        </div>
                        <div class="col-lg-3">
                            Berat Awal<br>
                            ...
                            Berat Tambahan<br>
                            <b><?php echo $po[$i]->beratTambahan ?> gr</b><br><br>
                            <input type="hidden"  required value="<?php echo $po[$i]->beratTambahan ?>" name="beratTambahan">
                            Jumlah Barang<br>
                            ...
                            PIC Awal<br>
                            <b><?php echo $po[$i]->namapic ?></b><br><br>
                            PIC Selanjutnya<br>
                    ...
                    <br>
                    <div class="row" >
                        <div class="col-lg-12 text-center" id='<?php echo $po[$i]->idProProd?>-cz?>-cek' style="display: none;">
                            Password tidak cocok. Silahkan coba lagi.
                        </div>
                        <div class="col-lg-12 text-center" id='<?php echo $po[$i]->idProProd?>-cz?>-cek1' style="display: none;">
                            Password valid.
                        </div>
                    </div>

                        <input type="hidden" value="<?php echo $po[$i]->idProProd?>" name="idProProd">
                        <input type="hidden" id="<?php echo $po[$i]->idProProd ?>-akt-i" required value="0" name="idAktivitas">
    ...
    <script type="text/javascript">
        function passing<?php echo $po[$i]->idProProd ?>() {
            ...
            document.getElementById('<?php echo $po[$i]->idProProd ?>-akt-d').innerHTML = namaakt;
            ...
            document.getElementById('<?php echo $po[$i]->idProProd ?>-akt-i').value = idakt;
        ...
        function cek<?php echo $po[$i]->idProProd ?>() {
            ...
            var x = document.getElementById("<?php echo $po[$i]->idProProd?>-cz?>-cek");
            var y = document.getElementById("<?php echo $po[$i]->idProProd?>-cz?>-cek1");
                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <a href="<?php echo base_url('user/createbommassal/'.$po[$i]->idSubSPK) ?>" type="button" class="btn btn-default btn-outline ">Detail BOM</a>
                            <button data-toggle="modal" data-dismiss="modal"  data-target="#reject<?php echo $po[$i]->idProProd ?>" class="btn btn-danger btn-outline">Reject</button>
                        </div>

                        <div class="modal inmodal fade" id="reject<?php echo $po[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                                ...
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="form-horizontal">
                                                        <div class="form-group"><label class="col-sm-3 control-label">Jumlah Barang Reject</label>
                                                            <div class="col-sm-9">
                                                                <input id="<?php echo $po[$i]->idProProd ?>-jml" type="number" step="any" name="jumlahReject" required min="1"  max=""  class="form-control">
                                                                <small>jumlah maksimal adalah <b><?php echo $po[$i]->jumlahNow?></b> pcs</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-horizontal">
                                                        <div class="form-group"><label class="col-sm-3 control-label">Berat Reject</label>
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input id="<?php echo $po[$i]->idProProd ?>-berat" type="number" step="any" required name="beratReject" value="" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <br><br>
                                                <button type="submit" onclick="return confirm('Apakah anda yakin untuk mengembalikan barang dari aktivitas produksi nomor faktur <?php echo $po[$i]->nomorFaktur ?> dan ID Sub SPK <?php echo $po[$i]->idSubSPK ?>?')"  class="btn btn-lg btn-primary btn-block">Simpan</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
