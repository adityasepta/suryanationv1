...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        <div class="col-lg-12 text-center ">
            ...
            <b class="pull-right "><?php echo $sl[$i]->nomorFaktur ?> - <?php echo $sl[$i]->idSubSPK ?> - <?php echo $sl[$i]->idWadah ?> | <?php echo $sl[$i]->jumlahNow ?> / <?php echo $sl[$i]->jumlah ?></b>
        </div>
        <div class="col-lg-12 text-center ">
            <span class="pull-left">Nama</span>
            <b class="pull-right"><?php echo $sl[$i]->namaCustomer ?></b>
        </div>
        <div class="col-lg-12 text-center ">
            <span class="pull-left">Produk</span>
            <b class="pull-right"><?php echo $sl[$i]->namaProduk ?></b>
        </div>
        <div class="col-lg-12 text-center ">
            <span class="pull-left">PIC</span>
            <b class="pull-right"><?php echo $sl[$i]->namapic ?></b>
        </div>
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                :&nbsp&nbsp<b><?php echo $sl[$i]->namap ?></b><br>
                :&nbsp&nbsp<b><?php echo substr($sl[$i]->model,0,18)?></b>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                :&nbsp&nbsp<b><?php echo $sl[$i]->kadarBahan ?> %</b>
        ...
        <div class="row">
            <div class="col-lg-6 text-center">
                Tgl Masuk<br>
                <b><?php echo $sl[$i]->tanggal ?></b>
            </div>

            <div class="col-lg-6 text-center ">
                Tgl Estimasi Selesai<br>
                <b><?php echo $sl[$i]->tanggalSelesai ?></b>
            </div>
        </div>
        <br>
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-3 control-label">Berat Awal</label>
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <small>berat maksimal adalah <b><?php echo ((float)$sl[$i]->beratAwal-(float)$sl[$i]->berat)+(float)$sl[$i]->beratTambahan?></b> gr</small>  
                                        </div>
                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <a href="<?php echo base_url('user/createbommassal/'.$sl[$i]->idSubSPK) ?>" type="button" class="btn btn-default btn-outline ">Detail BOM</a>
                            <button data-toggle="modal" data-dismiss="modal"  data-target="#reject<?php echo $sl[$i]->idProProd ?>" class="btn btn-danger btn-outline">Reject</button>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <br><br>
                                                <button type="submit" onclick="return confirm('Apakah anda yakin untuk mengembalikan barang dari aktivitas produksi nomor faktur <?php echo $sl[$i]->nomorFaktur ?> dan ID Sub SPK <?php echo $sl[$i]->idSubSPK ?>?')"  class="btn btn-lg btn-primary btn-block">Simpan</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
