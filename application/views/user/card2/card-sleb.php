    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
                ...
                <button data-toggle="modal" data-target="#serah<?php echo $sl[$i]->idProProd ?>" class="btn btn-xs btn-success btn-block"><span class="fa fa-check"></span></button>
        ...
        <div class="col-lg-3">
            ...
            <?php if($sl[$i]->statusWork == 'On Progress' AND $sl[$i]->statusBerat == 'Disetujui') { ?>
        
                

                <a href="<?php echo base_url('User/next3/'.$sl[$i]->idProduk.'/'.$idakt.'/'.$sl[$i]->idProProd.'/'.$sl[$i]->idSPK.'/'.$sl[$i]->idSubSPK.'/'.$sl[$i]->idWadah)?>" onclick="return confirm('Apakah anda yakin untuk melanjutkan aktivitas produksi nomor faktur <?php echo $sl[$i]->nomorFaktur ?>?')"  class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-right"></span></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <span >NO FAKTUR : <b class="text-success"><?php echo $sl[$i]->nomorFaktur ?></b> | ID SUB SPK : <b class="text-success"><?php echo $sl[$i]->idSubSPK ?></b>| ID Wadah : <b class="text-success"><?php echo $sl[$i]->idWadah ?></b></span><br>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <br><br>
                            <a href="<?php echo base_url('User/approve2/'.$sl[$i]->idProProd) ?>" onclick="return confirm('Apakah anda yakin untuk menyetujui berat dari aktivitas produksi nomor faktur <?php echo $sl[$i]->nomorFaktur ?> dan ID Sub SPK <?php echo $sl[$i]->idSubSPK ?>?')"  class="btn btn-lg btn-primary btn-block">Validasi</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            ...
                            <li class=""><a data-toggle="tab" href="#tab-3<?php echo $sl[$i]->idProProd ?>">Berat</a></li>
                        </ul>
                        <div class="tab-content">
                                    ...
                                    <table class="table table-hover table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Penjadwalan</td>
                                                <td class="text-center"><?php echo $sl[$i]->tanggaljadwal?></td>
                                                <td class="text-center"><label class="label label-xs label-primary">Diterima</label></td>
                                            </tr>
                            ...
                            <div id="tab-3<?php echo $sl[$i]->idProProd ?>" class="tab-pane">
                                <div class="panel-body">
                                    <div class="row">
                                        <table class="table table-hover table-responsive">
                                            <thead>
                                            ...
                                            <tbody>
                                                <?php for ($j=0; $j < count($b) ; $j++) { 
                                                    if($b[$j]->idSubSPK == $sl[$i]->idSubSPK and $b[$j]->idAktivitas == '1006') { ?>
                                                ...
                                                <?php }
                                                    if($b[$j]->idWadah == $sl[$i]->idWadah and $b[$j]->idAktivitas > 1006) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                                ...
                                                                <button data-toggle="modal"  data-dismiss="modal" data-target="#<?php echo $b[$j]->idAktivitas ?><?php echo $sl[$i]->idProProd ?>" class="btn btn-xs btn-info">Update Berat</button>
                                                                ...
                                                                <div class="modal inmodal fade" id="<?php echo $b[$j]->idAktivitas ?><?php echo $sl[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col-lg-5">
                            <button data-toggle="modal" data-dismiss="modal" data-target="#pic<?php echo $sl[$i]->idProProd ?>"  class="btn btn-info btn-block btn-outline">Tambah PIC</button>
                        ...
                        <div class="col-lg-7">
                            ...
                            <a href="<?php echo base_url('user/invoiceMassal/'.$sl[$i]->nomorFaktur) ?>" type="button" class="btn btn-default btn-outline ">Detail SPK</a>
