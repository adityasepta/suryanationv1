            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 text-center">
                            <input type="password" id="<?php echo $sl[$i]->idProProd ?>-sleb?>-password-2" required  value="0" name="password2">
                        </div>
                        <div class="col-lg-4 text-center">
                            <button type="button" onclick="ceksleb<?php echo $sl[$i]->idProProd ?>();" class="btn btn-xs btn-primary btn-block">Cek</button>
                        </div>
                    </div>
                    <br>
                    <div class="row" >
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <br><br>
                            <button type="submit" onclick="return confirm('Apakah anda yakin untuk menyetujui berat dari aktivitas produksi nomor faktur <?php echo $sl[$i]->nomorFaktur ?> dan ID Sub SPK <?php echo $sl[$i]->idSubSPK ?>?')"  class="btn btn-lg btn-primary btn-block" id="<?php echo $sl[$i]->idProProd?>-sleb" disabled="true">Validasi</button>
                        </div>
                    </div>
                </div>
                <?php echo form_close();?>
