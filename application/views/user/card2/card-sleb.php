...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php if(($sl[$i]->statusWork == 'On Progress' or $sl[$i]->statusWork == 'Waiting') AND $sl[$i]->statusBerat == 'Disetujui') { ?>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-3 control-label">Jumlah Barang</label>
                                        ...
                                        <div class="col-sm-9"><input type="number" step="any" name="jumlah" required min="1"  max="<?php echo $sl[$i]->jumlahNow?>"  class="form-control"></div>
                                    </div>
                                </div>
                                <div class="form-horizontal">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <span >NO FAKTUR : <b class="text-success"><?php echo $sl[$i]->nomorFaktur ?></b> | ID SUB SPK : <b class="text-success"><?php echo $sl[$i]->idSubSPK ?></b></span><br>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-center">
                            Jumlah Barang<br>
                            <b><?php echo $sl[$i]->jumlah ?> pieces</b><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <?php if($sl[$i]->statusWork == 'On Progress') {?>
                                <button data-toggle="modal" data-dismiss="modal" data-target="#berat<?php echo $sl[$i]->idProProd ?>"  class="btn btn-warning btn-block btn-outline">Tambah Berat</button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group"><label class="col-sm-5 control-label">Berat Akhir <?php echo $namakt ?></label>
                                                    ...
                                                    <div class="col-sm-2"><input type="hidden" name="idProProd" readonly class="form-control" value="<?php echo $sl[$i]->idProProd ?>"></div>
                                                </div>
                                            </div>
