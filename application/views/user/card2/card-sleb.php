            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <br><br>
                            <button type="submit" onclick="return confirm('Apakah anda yakin untuk menyetujui berat dari aktivitas produksi nomor faktur <?php echo $sl[$i]->nomorFaktur ?> dan ID Sub SPK <?php echo $sl[$i]->idSubSPK ?>?')"  class="btn btn-lg btn-primary btn-block" id="tombolvalidasi" disabled="true">Validasi</button>
                        </div>
                    </div>
                </div>
                <?php echo form_close();?>
