...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php if(($go[$i]->statusWork == 'On Progress' or $go[$i]->statusWork == 'Waiting') AND $go[$i]->statusBerat == 'Disetujui') { ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <span >NO FAKTUR : <b class="text-success"><?php echo $go[$i]->nomorFaktur ?></b> | ID SUB SPK : <b class="text-success"><?php echo $go[$i]->idSubSPK ?></b></span><br>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-center">
                            Jumlah Barang<br>
                            <b><?php echo $go[$i]->jumlah ?> pieces</b><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <?php if($go[$i]->statusWork == 'On Progress') {?>
                                <button data-toggle="modal" data-dismiss="modal" data-target="#berat<?php echo $go[$i]->idProProd ?>"  class="btn btn-warning btn-block btn-outline">Tambah Berat</button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group"><label class="col-sm-5 control-label">Berat Akhir <?php echo $namakt ?></label>
                                                    ...
                                                    <div class="col-sm-2"><input type="hidden" name="idProProd" readonly class="form-control" value="<?php echo $go[$i]->idProProd ?>"></div>
                                                </div>
                                            </div>
