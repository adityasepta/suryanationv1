...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <?php } else if(($kr[$i]->statusWork == 'On Progress')){ ?>
        ...
        <div class="col-lg-3">
            ...
            <?php if(($kr[$i]->statusWork == 'On Progress' or $kr[$i]->statusWork == 'Waiting') AND $kr[$i]->statusBerat == 'Disetujui') { ?>
        
                

           <a data-toggle="modal" data-target="#kasih<?php echo $kr[$i]->idProProd ?>" class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-right"></span></a>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-3 control-label">Jumlah Barang</label>
                                        ...
                                        <div class="col-sm-9"><input type="number" step="any" name="jumlah" required min="1"  max="<?php echo $kr[$i]->jumlahNow?>"  class="form-control"></div>
                                    </div>
                                </div>
                                <div class="form-horizontal">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <span >NO FAKTUR : <b class="text-success"><?php echo $kr[$i]->nomorFaktur ?></b> | ID SUB SPK : <b class="text-success"><?php echo $kr[$i]->idSubSPK ?></b></span><br>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-center">
                            Berat Awal<br>
                            <b><?php echo $kr[$i]->beratAwal ?> gr</b><br><br>
                        ...
                        <div class="col-lg-3 text-center">
                            Jumlah Barang<br>
                            <b><?php echo $kr[$i]->jumlah ?> pieces</b><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <?php if($kr[$i]->statusWork == 'On Progress') {?>
                                <button data-toggle="modal" data-dismiss="modal" data-target="#berat<?php echo $kr[$i]->idProProd ?>"  class="btn btn-warning btn-block btn-outline">Tambah Berat</button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group"><label class="col-sm-5 control-label">Berat Akhir <?php echo $namakt ?></label>
                                                    ...
                                                    <div class="col-sm-2"><input type="hidden" name="idProProd" readonly class="form-control" value="<?php echo $kr[$i]->idProProd ?>"></div>
                                                </div>
                                            </div>
