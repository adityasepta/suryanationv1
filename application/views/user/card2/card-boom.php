...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        <div class="col-lg-12 text-center ">
            ...
            <b class="pull-right "><?php echo $bo[$i]->nomorFaktur ?> - <?php echo $bo[$i]->idSubSPK ?> - <?php echo $bo[$i]->idWadah ?> | <?php echo $bo[$i]->jumlahNow ?> / <?php echo $bo[$i]->jumlah ?></b>
        </div>
        <div class="col-lg-12 text-center ">
            <span class="pull-left">Nama</span>
            <b class="pull-right"><?php echo $bo[$i]->namaCustomer ?></b>
        </div>
        <div class="col-lg-12 text-center ">
            <span class="pull-left">Produk</span>
            <b class="pull-right"><?php echo $bo[$i]->namaProduk ?></b>
        </div>
        <div class="col-lg-12 text-center ">
            <span class="pull-left">PIC</span>
            <b class="pull-right"><?php echo $bo[$i]->namapic ?></b>
        </div>
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                :&nbsp&nbsp<b><?php echo $bo[$i]->namasales ?></b>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                :&nbsp&nbsp<b><?php echo $bo[$i]->kadarBahan ?> %</b>
        ...
        <div class="row">
            <div class="col-lg-6 text-center">
                Tgl Masuk<br>
                <b><?php echo $bo[$i]->tanggal ?></b>
            </div>

            <div class="col-lg-6 text-center ">
                Tgl Estimasi Selesai<br>
                <b><?php echo $bo[$i]->tanggalSelesai ?></b>
            </div>
        </div>
        <br>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <button data-toggle="modal" data-target="#kasih<?php echo $bo[$i]->idProProd ?>" class="btn btn-xs btn-success btn-block">Lanjut Aktivitas</button>
                ...
                <div class="modal-body">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-3 control-label">Jumlah Barang</label>
                                        ...
                                        <div class="col-sm-9">
                                            <input id="<?php echo $bo[$i]->idProProd ?>-jml" type="number" step="any" name="jumlah" required min="1"  max=""  class="form-control">
                                            <small>jumlah maksimal adalah <b><?php echo $bo[$i]->jumlahNow?></b> pcs</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-3 control-label">Berat Awal</label>
                                        ...
                                        <div class="col-sm-9">
                                            <input id="<?php echo $bo[$i]->idProProd ?>-berat" type="number" step="any" required name="beratAwal" value="" class="form-control">
                                            <small>berat maksimal adalah <b><?php echo ((float)$bo[$i]->beratAwal-(float)$bo[$i]->berat)+(float)$bo[$i]->beratTambahan?></b> gr</small>  
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <button onclick="passing<?php echo $bo[$i]->idProProd ?>();" data-toggle="modal" data-dismiss="modal" data-target="#serah<?php echo $bo[$i]->idProProd ?>" class="btn btn-block btn-success">Simpan</button>
                        </div>
                    </div>
                    <!-- <?php echo form_close()?> -->
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-9 text-center">
                            ...
                            <h1 id="<?php echo $bo[$i]->idProProd ?>-akt-d" class="text-success"></h1>
                        </div>
                        <div class="col-lg-3">
                            Berat Awal<br>
                            <b id="<?php echo $bo[$i]->idProProd ?>-berat-d"></b><br><br>
                            ...
                            PIC Awal<br>
                            <b><?php echo $bo[$i]->namapic ?></b><br><br>
                            PIC Selanjutnya<br>
                            <b id="<?php echo $bo[$i]->idProProd ?>-pic-d"></b>
                            <input type="hidden" id="<?php echo $bo[$i]->idProProd ?>-pic-i" required value="0" name="staf">
                            <input type="hidden" id="password-pic-<?php echo $bo[$i]->idProProd ?>" required value="0" name="password">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 text-center">
                            <input type="password" id="password-pic-2<?php echo $bo[$i]->idProProd ?>" required  value="0" name="password2">
                        </div>
                        <div class="col-lg-4 text-center">
                            <button type="button" onclick="cek<?php echo $bo[$i]->idProProd ?>();" class="btn btn-xs btn-primary btn-block">Cek</button>
                        </div>
                    </div>
                    <br>
                    <div class="row" >
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <br><br>
                            <button type="submit" onclick="return confirm('Apakah anda yakin untuk menyetujui berat dari aktivitas produksi nomor faktur <?php echo $bo[$i]->nomorFaktur ?> dan ID Sub SPK <?php echo $bo[$i]->idSubSPK ?>?')"  class="btn btn-lg btn-primary btn-block" id="tombolvalidasi<?php echo $bo[$i]->idProProd ?>" disabled="true">Validasi</button>
                        </div>
                    </div>
                </div>
                <?php echo form_close();?>
    ...
    <script type="text/javascript">
        function passing<?php echo $bo[$i]->idProProd ?>() {
            var jumlah = document.getElementById('<?php echo $bo[$i]->idProProd ?>-jml').value;
            var berat = document.getElementById('<?php echo $bo[$i]->idProProd ?>-berat').value;
            ...
            $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#password-pic-<?php echo $bo[$i]->idProProd ?>").val(Vals[0].password);
                    }
            });
        ...
        function cek<?php echo $bo[$i]->idProProd ?>() {
            var password = document.getElementById('password-pic-<?php echo $bo[$i]->idProProd ?>').value;
            var password2 = document.getElementById('password-pic-2<?php echo $bo[$i]->idProProd ?>').value;
            ...
            if(password==password2) {
                ...
                $('#tombolvalidasi<?php echo $bo[$i]->idProProd ?>').prop('disabled', true);
                ...
                <div class="modal-footer">
                    <div class="row">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group"><label class="col-sm-5 control-label">Berat Akhir <?php echo $namakt ?></label>
                                                    ...
                                                    <div class="col-sm-5"><input type="text" value="<?php echo $bo[$i]->berat?>" readonly class="form-control" readonly name="berat" class="form-control"></div>
                        ...
                        <div class="col-lg-9">
                            ...
                            <a href="<?php echo base_url('user/createbommassal/'.$bo[$i]->idSubSPK) ?>" type="button" class="btn btn-default btn-outline ">Detail BOM</a>
                            <button data-toggle="modal" data-dismiss="modal"  data-target="#reject<?php echo $bo[$i]->idProProd ?>" class="btn btn-danger btn-outline">Reject</button>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                                ...
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="form-horizontal">
                                                        <div class="form-group"><label class="col-sm-3 control-label">Jumlah Barang Reject</label>
                                                            <div class="col-sm-9">
                                                                <input id="<?php echo $bo[$i]->idProProd ?>-jml" type="number" step="any" name="jumlahReject" required min="1"  max=""  class="form-control">
                                                                <small>jumlah maksimal adalah <b><?php echo $bo[$i]->jumlahNow?></b> pcs</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-horizontal">
                                                        <div class="form-group"><label class="col-sm-3 control-label">Berat Reject</label>
                                                            ...
                                                            <div class="col-sm-9">
                                                                ...
                                                                <small>berat maksimal adalah <b><?php echo ((float)$bo[$i]->beratAwal-(float)$bo[$i]->berat)?></b> gr</small>  
                                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <br><br>
                                                <button type="submit" onclick="return confirm('Apakah anda yakin untuk mengembalikan barang dari aktivitas produksi nomor faktur <?php echo $bo[$i]->nomorFaktur ?> dan ID Sub SPK <?php echo $bo[$i]->idSubSPK ?>?')"  class="btn btn-lg btn-primary btn-block">Simpan</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
