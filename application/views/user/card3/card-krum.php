...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
            <a href="<?php echo base_url('User/next7/'.$kr[$i]->idProduk.'/'.$idakt.'/'.$kr[$i]->idProProd.'/'.$kr[$i]->idSPK)?>" onclick="return confirm('Apakah anda yakin untuk melanjutkan aktivitas produksi nomor faktur <?php echo $kr[$i]->nomorFaktur ?>?')"  class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-right"></span></a>
            <?php } ?>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <br><br>
                            <a href="<?php echo base_url('User/approve3/'.$kr[$i]->idProProd) ?>" onclick="return confirm('Apakah anda yakin untuk menyetujui berat dari aktivitas produksi nomor faktur <?php echo $kr[$i]->nomorFaktur ?>?')"  class="btn btn-lg btn-primary btn-block">Validasi</a>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <table class="table table-hover table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $rt = 1; for ($z=0; $z < count($b) ; ++$z) { 
                                                    if($b[$z]->idSPK == $kr[$i]->idSPK AND (int)$b[$z]->idAktivitas > 1006 ) {
                                                ?>
