...
<li class="element" id="task1">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <?php if (($k2[$i]->statusWork !== 'Belum ada PIC') ) { ?>
            <a href="<?php echo base_url('user/next4/'.$k2[$i]->idKloter.'/1005') ?>" class="btn btn-block btn-info btn-xs" onclick="return confirm('Apakah anda yakin untuk melanjutkan aktivitas produksi kloter dengan nama kloter <?php echo $k2[$i]->nama ?> ?')"><span class="fa fa-arrow-right"></span></a>
            <?php } else { ?>
