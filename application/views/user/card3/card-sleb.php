...
<li class="<?php echo $statr ?>-element" id="task1">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
            <a href="<?php echo base_url('User/next7/'.$sl[$i]->idProduk.'/'.$idakt.'/'.$sl[$i]->idProProd.'/'.$sl[$i]->idSPK)?>" onclick="return confirm('Apakah anda yakin untuk melanjutkan aktivitas produksi nomor faktur <?php echo $sl[$i]->nomorFaktur ?>?')"  class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-right"></span></a>
            <?php } ?>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <br><br>
                            <a href="<?php echo base_url('User/approve3/'.$sl[$i]->idProProd) ?>" onclick="return confirm('Apakah anda yakin untuk menyetujui berat dari aktivitas produksi nomor faktur <?php echo $sl[$i]->nomorFaktur ?>?')"  class="btn btn-lg btn-primary btn-block">Validasi</a>
                        </div>
                    </div>
                </div>
            </div>
