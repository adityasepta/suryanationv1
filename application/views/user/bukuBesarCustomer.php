    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="<?php echo base_url();?>user/bukuBesarCustomer">Beranda</a>
                    </li>
                    <li class="active">
                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            <?php echo form_open_multipart('user/bukuBesarCustomer/')?>
                            <?php 
                              $tglskg = new DateTime();
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <h3>Filter Laporan Buku Besar Customer Berdasarkan Tanggal</h3>
                                    <hr>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <select name="idCustomer" class="form-control" required="">
                                            ...
                                            <option value="<?php echo $customer->idCustomer?>" 
                                                <?php if($customer->idCustomer==$idCustomer_pilih) { 
                                                    $namaCustomer_pilih = $customer->namaCustomer;
                                                    echo "selected ";}?>><?php echo $customer->namaCustomer?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            <div class="modal-header">
                                ...
                                <h2 class="text-center"><b>Buku Besar Per Customer</b></h2>
                                <?php 
                                ...
                                <p class="text-left text-navy"><b>Customer &nbsp;&nbsp;: <?php echo $namaCustomer_pilih?>
                                <?php } ?>
                            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <?php $debit=0; $kredit=0; for ($i=0; $i < count($bukuBesar); $i++) { ?>
                                        <tr>
                                            <td>
                                                <?php 
                                                    $tgl = new DateTime($bukuBesar[$i]->tgl);
