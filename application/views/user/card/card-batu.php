...
<li class="<?php echo $statr?>-element" id="task1">
    <div class="row">
        <div class="col-lg-5 text-center">
            <img src="<?php echo base_url('uploads/gambarDesain/'.$bt[$i]->kodeGambar.'-thumb.jpg')?>"  class="img-responsive" onerror="this.onerror=null;this.src='<?php echo base_url('assets/img/noimage2.png')?>';" >
        </div>
        <div class="col-lg-7">
            <b><?php echo substr($bt[$i]->namaCustomer,0,10) ?> / <?php echo $bt[$i]->nomorFaktur ?></b><br>
            <b><?php echo $bt[$i]->jenisProduk?></b><br>
            <b><?php echo $bt[$i]->tanggal?> -</b><br>
            <b><?php echo $bt[$i]->tanggalSelesai?> </b><br>
        </div>
    </div>
    <hr>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <?php if ($bt[$i]->statusWork == 'Belum ada PIC') { ?>
                <button data-toggle="modal" data-target="#pic<?php echo $bt[$i]->idProProd ?>"  class="btn btn-xs btn-success btn-block" onclick="tambahpic<?php echo $bt[$i]->idProProd ?>();">Tambah PIC</button>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-center">
                            Berat Awal<br>
                            <b><?php echo $bt[$i]->beratAwal+$bt[$i]->beratTambahan ?> gr</b><br><br>
                            PIC Proses<br>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-horizontal">
                        <div class="form-group"><label class="col-sm-5 control-label">Berat Awal <?php echo $namakt ?></label>
                            ...
                            <div class="col-sm-5"><input type="number" step="any" readonly="" value="<?php echo $bt[$i]->beratAwal+$bt[$i]->beratTambahan?>" class="form-control">
                                <input type="hidden" step="any" name="beratAwal" readonly="" value="<?php echo $bt[$i]->beratAwal?>" class="form-control"></div>
                        </div>
                    </div>
                    <div class="form-horizontal">
                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <button data-toggle="modal" data-dismiss="modal"  data-target="#reject<?php echo $bt[$i]->idProProd ?>" class="btn btn-danger btn-outline">Reset</button>
                        </div>

                        <div class="modal inmodal fade" id="reject<?php echo $bt[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <?php echo form_close(); ?>
                                    <?php
                                    $atribut = array('id' => $bt[$i]->idProProd."form");
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                                ...
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="form-horizontal">
                                                        <div class="form-group"><label class="col-sm-3 control-label">Berat Barang Reject</label>
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input id="<?php echo $bt[$i]->idProProd ?>-berat" type="number" step="any" required name="beratReject" value="" class="form-control">
                                                            </div>
                                            ...
                                            <input type="hidden" value="<?php echo $bt[$i]->idProProd?>" name="idProProd">
                                            <input type="hidden" value="<?php echo $bt[$i]->idProduk ?>" name="idProduk">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group"><label class="col-sm-3 control-label">Pilih / Ubah PIC</label>
                            ...
                            <div class="col-sm-7">
                                ...
                                $js = array( 'class' => 'form-control', 'onchange' => 'passing'.$bt[$i]->idProProd.'()', 'id' =>  $bt[$i]->idProProd."-pic");
                                echo form_dropdown('staf', $staf, $bt[$i]->idPIC,$js);
