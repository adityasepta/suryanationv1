                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4 text-center">
                                                                        ...
                                                                        <img src="<?php echo base_url('uploads/gambarProduk/'.$li[$x]->kodeGambar.'-cust.jpg')?>"  class="img-responsive" onerror="this.onerror=null;this.src='<?php echo base_url('assets/img/noimage2.png')?>';" >
                                                                    </div>
                                                                    <div class="col-lg-4 text-center">
                                                                        <b>Foto 3D Model</b><br><br>
                                                                        <?php if($li[$x]->statusDesain !== 'Proses Desain') {?>
                                                                        <img src="<?php echo base_url('uploads/gambarDesain/'.$li[$x]->kodeGambar.'-d1.jpg')?>"  class="img-responsive" onerror="this.onerror=null;this.src='<?php echo base_url('assets/img/noimage2.png')?>';" >
                                                                        <?php } ?>
                                                                    </div>
                                                                    <div class="col-lg-4 text-center">
                                                                        <b>Foto PIC</b><br><br>
                                                                ...
                                                                <table class="table table-hover table-responsive">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>Desain</td>
                                                                            <td class="text-center"><?php echo $li[$x]->tanggaldes?></td>
