                            ...
                            <div class="modal-footer">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 text-right ">
                                        ...
                                        <button data-toggle="modal" data-dismiss="modal"  data-target="#reject<?php echo $gi[$i]->idProProd ?>" class="btn btn-danger btn-outline">Reset</button>
                                    </div>

                                    <div class="modal inmodal fade" id="reject<?php echo $gi[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <?php echo form_close(); ?>
                                                <?php
                                                $atribut = array('id' => $gi[$i]->idProProd."form");
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <input type="hidden" value="<?php echo $gi[$i]->idProProd?>" name="idProProd">
                                                        <input type="hidden" value="<?php echo $gi[$i]->idProduk ?>" name="idProduk">
