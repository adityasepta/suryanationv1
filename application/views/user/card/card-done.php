                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            <button data-toggle="modal" data-dismiss="modal"  data-target="#reject<?php echo $do[$i]->idProProd ?>" class="btn btn-danger btn-outline">Reset</button>
                        </div>

                        <div class="modal inmodal fade" id="reject<?php echo $do[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <?php echo form_close(); ?>
                                    <?php
                                    $atribut = array('id' => $do[$i]->idProProd."form");
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-horizontal">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <?php 
                                                            $js = array( 'class' => 'form-control', 'id' =>  $do[$i]->idProProd."-pic");
                                                            echo form_dropdown('staf', $staf, $do[$i]->idPIC,$js);
                                                            ?>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-horizontal">
                                                        <div class="form-group"><label class="col-sm-3 control-label">Berat Barang Reject</label>
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input id="<?php echo $do[$i]->idProProd ?>-berat" type="number" step="any" required name="beratReject" value="" class="form-control">
                                                            </div>
                                            ...
                                            <input type="hidden" value="<?php echo $do[$i]->idProProd?>" name="idProProd">
