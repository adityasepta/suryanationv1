                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-center">
                            Berat Awal<br>
                            <b><?php echo $po[$i]->beratAwal+$po[$i]->beratTambahan ?> gr</b><br><br>
                            PIC Proses<br>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-horizontal">
                        <div class="form-group"><label class="col-sm-5 control-label">Berat Awal <?php echo $namakt ?></label>
                            ...
                            <div class="col-sm-5"><input type="number" step="any" readonly="" value="<?php echo $po[$i]->beratAwal+$po[$i]->beratTambahan?>" class="form-control">
                                <input type="hidden" step="any" name="beratAwal" readonly="" value="<?php echo $po[$i]->beratAwal?>" class="form-control"></div>
                        </div>
                    </div>
                    <div class="form-horizontal">
                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <button data-toggle="modal" data-dismiss="modal"  data-target="#reject<?php echo $po[$i]->idProProd ?>" class="btn btn-danger btn-outline">Reset</button>
                        </div>
