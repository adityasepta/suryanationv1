...
<li class="element" id="task1">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php } else  { ?>                          
                <a href="<?php echo base_url('user/next2/'.$k3[$i]->idKloter.'/'.$idakt) ?>" class="btn btn-block btn-success btn-xs" onclick="return confirm('Apakah anda yakin untuk finalisasi Kloter dengan nama kloter <?php echo $k3[$i]->nama ?> ?')"  class="btn btn-xs btn-success btn-block">Lanjut Aktivitas</a>
            <?php } ?>
