...
<li class="element" id="task1">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4 text-center">
                                                                        ...
                                                                        <img src="<?php echo base_url('uploads/gambarProduk/'.$co[$x]->kodeGambar.'-cust.jpg')?>" class="img-responsive">
                                                                    </div>
                                                                    <div class="col-lg-4 text-center">
                                                                        <b>Foto 3D Model</b><br><br>
                                                                        <?php if($co[$x]->statusDesain !== 'Proses Desain') {?>
                                                                        <img src="<?php echo base_url('uploads/gambarDesain/'.$co[$x]->kodeGambar.'-d1.jpg')?>" class="img-responsive">
                                                                        <?php } ?>
                                                                    </div>
                                                                    <div class="col-lg-4 text-center">
                                                                        <b>Foto PIC</b><br><br>
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <?php if (($k3[$i]->statusWork !== 'Belum ada PIC') ) { ?>
            <a href="<?php echo base_url('user/next2/'.$k3[$i]->idKloter.'/1006') ?>" class="btn btn-block btn-info btn-xs" onclick="return confirm('Apakah anda yakin untuk melanjutkan aktivitas produksi kloter dengan nama kloter <?php echo $k3[$i]->nama ?> ?')"><span class="fa fa-arrow-right"></span></a>
            <?php } else { ?>
