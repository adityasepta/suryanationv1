...
<li class="<?php echo $statr?>-element" id="task1">
    <div class="row">
        ...
        <div class="col-lg-7">
            <b><?php echo substr($sl[$i]->namaCustomer,0,10) ?> / <?php echo $sl[$i]->nomorFaktur ?></b><br>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <?php if ($sl[$i]->statusWork == 'Belum ada PIC') { ?>
                <button data-toggle="modal" data-target="#pic<?php echo $sl[$i]->idProProd ?>"  class="btn btn-xs btn-success btn-block" onclick="tambahpic<?php echo $sl[$i]->idProProd ?>();">Tambah PIC</button>
            <?php } else if($sl[$i]->statusWork == 'On Progress' AND $sl[$i]->berat == 0 ) {  ?>
                <button data-toggle="modal" data-dismiss="modal" data-target="#berat<?php echo $sl[$i]->idProProd ?>"  class="btn btn-xs btn-success btn-block">Tambah Berat</button>
            <?php } else if($sl[$i]->statusWork == 'On Progress' AND $sl[$i]->berat > 0 AND $sl[$i]->statusBerat == 'Belum Disetujui' ) { ?>                
                <button data-toggle="modal" data-target="#serah<?php echo $sl[$i]->idProProd ?>" class="btn btn-xs btn-success btn-block">Validasi Berat</button>
            <?php } else if($sl[$i]->statusWork == 'On Progress' AND $sl[$i]->statusBerat == 'Disetujui' ) { ?>                
                <a  data-toggle="modal" data-target="#akt<?php echo $sl[$i]->idProProd ?>" class="btn btn-xs btn-success btn-block">Lanjut Aktivitas</a>
            <?php } ?>
        </div>
    ...
    <div class="modal inmodal fade" id="akt<?php echo $sl[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" value="<?php echo $sl[$i]->idProProd?>" name="idProProd">
                                    <input type="hidden" class="form-control" value="<?php echo $sl[$i]->idProduk?>" name="idProduk">
                                    <input type="hidden" class="form-control" value="<?php echo $sl[$i]->idSPK?>" name="idSPK">
                            <div class="col-sm-2">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-center">
                            Berat Awal<br>
                            <b><?php echo $sl[$i]->beratAwal+$sl[$i]->beratTambahan ?> gr</b><br><br>
                            PIC Proses<br>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-horizontal">
                        <div class="form-group"><label class="col-sm-5 control-label">Berat Awal <?php echo $namakt ?></label>
                            ...
                            <div class="col-sm-5"><input type="number" step="any" readonly="" value="<?php echo $sl[$i]->beratAwal+$sl[$i]->beratTambahan?>" class="form-control">
                                <input type="hidden" step="any" name="beratAwal" readonly="" value="<?php echo $sl[$i]->beratAwal?>" class="form-control"></div>
                        </div>
                    </div>
                    <div class="form-horizontal">
                   ...
                   <div class="row">
                        <div class="col-lg-6">
                            <button data-toggle="modal" data-dismiss="modal" data-target="#berat<?php echo $sl[$i]->idProProd ?>" class="btn btn-danger btn-block">Kembali</button>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="modal-body">
                    ...
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            ...
                            <li class=""><a data-toggle="tab" href="#tab-2<?php echo $sl[$i]->idProProd ?>">Jadwal</a></li>
                        ...
                        <div class="tab-content">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 text-center">
                                            ...
                                            <img src="<?php echo base_url('uploads/gambarDesain/'.$sl[$i]->kodeGambar.'-d1.jpg')?>"  class="img-responsive" onerror="this.onerror=null;this.src='<?php echo base_url('assets/img/noimage2.png')?>';" >
                                            <?php } ?>
                                        </div>
                                        <div class="col-lg-4 text-center">
                                            <b>Foto PIC</b><br><br>
                            ...
                            <div id="tab-2<?php echo $sl[$i]->idProProd ?>" class="tab-pane">
                                <div class="panel-body">
                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <button data-toggle="modal" data-dismiss="modal"  data-target="#reject<?php echo $sl[$i]->idProProd ?>" class="btn btn-danger btn-outline">Reset</button>
                        </div>

                        <div class="modal inmodal fade" id="reject<?php echo $sl[$i]->idProProd ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group"><label class="col-sm-3 control-label">Pilih / Ubah PIC</label>
                            ...
                            <div class="col-sm-7">
                                ...
                                $js = array( 'class' => 'form-control', 'onchange' => 'passing'.$sl[$i]->idProProd.'()', 'id' =>  $sl[$i]->idProProd."-pic");
                                echo form_dropdown('staf', $staf, $sl[$i]->idPIC,$js);
                    ...
                    <div class="form-horizontal">
                            <div class="form-group"><label class="col-sm-3 control-label">Password PIC</label>
                                ...
                                <div class="col-sm-4">
                                    <input type="password" id="<?php echo $sl[$i]->idProProd?>-boom?>-password-2" required  value="0" name="password2" class="form-control">
                                    <input type="hidden" id="<?php echo $sl[$i]->idProProd?>-boom?>-password-1" required value="0" name="password">
                                </div>
                                <div class="col-sm-2">
                                    <button type="button" onclick="cekboom<?php echo $sl[$i]->idProProd?>();" class="btn btn-sm btn-primary btn-block">Cek</button>
                                </div>
                        ...
                        <div class="form-horizontal" >
                            <div class="form-group">
                            <div class="col-lg-12 text-center" id='<?php echo $sl[$i]->idProProd?>-boom?>-cek' style="display: none;">
                                Password tidak cocok. Silahkan coba lagi.
                            </div>
                            <div class="col-lg-12 text-center" id='<?php echo $sl[$i]->idProProd?>-boom?>-cek1' style="display: none;">
                                Password valid.
                            </div>
                             </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <button type="submit" class="btn btn-block btn-success" id="<?php echo $sl[$i]->idProProd?>-boom" disabled="true">Simpan</button>
                        </div>
                    </div>
                    <?php echo form_close() ?>
                </div>
...
<script type="text/javascript">
        function tambahpic<?php echo $sl[$i]->idProProd ?>() {
            passing<?php echo $sl[$i]->idProProd ?>();
        };
        ...
        function passing<?php echo $sl[$i]->idProProd ?>() {
            ...
            $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("input[id='<?php echo $sl[$i]->idProProd?>-boom?>-password-1']").val(Vals[0].password);
                    }
            });
        }
</script>
<script type="text/javascript">
        function cekboom<?php echo $sl[$i]->idProProd?>() {
            var password = document.getElementById('<?php echo $sl[$i]->idProProd ?>-boom?>-password-1').value;
            var password2 = document.getElementById('<?php echo $sl[$i]->idProProd ?>-boom?>-password-2').value;
            console.log(password);
            console.log(password2);
            var x = document.getElementById("<?php echo $sl[$i]->idProProd ?>-boom?>-cek");
            var y = document.getElementById("<?php echo $sl[$i]->idProProd ?>-boom?>-cek1");

            if(password==password2) {
                $('#<?php echo $sl[$i]->idProProd ?>-boom').prop('disabled', false);
                x.style.display = "none";
                y.style.display = "block";
            }
            else {
                $('#<?php echo $sl[$i]->idProProd ?>-boom').prop('disabled', true);
