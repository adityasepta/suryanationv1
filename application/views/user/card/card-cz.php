    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
                ...
                <button data-toggle="modal" data-target="#serah<?php echo $cz[$i]->idProProd ?>" class="btn btn-xs btn-success btn-block"><span class="fa fa-check-square-o"></span></button>
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
            <a data-toggle="modal" data-target="#akt<?php echo $cz[$i]->idProProd ?>" class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-left"></span>&nbsp&nbsp<span class="fa fa-arrow-right"></span></a>
            <!-- <a href="<?php echo base_url('User/next/'.$cz[$i]->idProduk.'/'.$idakt.'/'.$cz[$i]->idProProd.'/'.$cz[$i]->idSPK)?>" onclick="return confirm('Apakah anda yakin untuk melanjutkan aktivitas produksi nomor faktur <?php echo $cz[$i]->nomorFaktur ?>?')"  class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-right"></span></a> -->
            <?php } ?>
        </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 text-center">
                                            ...
                                            <img src="<?php echo base_url('uploads/gambarDesain/'.$cz[$i]->kodeGambar.'-d1.jpg')?>" class="img-responsive">
                                            <?php } ?>
                                        </div>
                                        <div class="col-lg-4 text-center">
                                            <b>Foto PIC</b><br><br>
