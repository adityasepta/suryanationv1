    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
                ...
                <button data-toggle="modal" data-target="#serah<?php echo $kr[$i]->idProProd ?>" class="btn btn-xs btn-success btn-block"><span class="fa fa-check-square-o"></span></button>
        ...
        <div class="col-lg-3">
            ...
            <?php } else {?>
            <a data-toggle="modal" data-target="#akt<?php echo $kr[$i]->idProProd ?>" class="btn btn-xs btn-info btn-block"><span class="fa fa-arrow-left"></span>&nbsp&nbsp<span class="fa fa-arrow-right"></span></a>
