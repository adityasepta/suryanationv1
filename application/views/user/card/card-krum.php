                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <button data-toggle="modal" data-dismiss="modal"  data-target="#reject<?php echo $kr[$i]->idProProd ?>" class="btn btn-danger btn-outline">Reset</button>
                        </div>
                                                ...
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="form-horizontal">
                                                        <div class="form-group"><label class="col-sm-3 control-label">Berat Barang Reject</label>
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input id="<?php echo $kr[$i]->idProProd ?>-berat" type="number" step="any" required name="beratReject" value="" class="form-control">
                                                            </div>
