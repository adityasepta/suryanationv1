        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <!-- <span >NO PO : <b class="text-success"><?php echo $j[$i]->nomorPO ?></b> | TIPE : <b class="text-success"><?php echo $j[$i]->tipeOrder ?></b></span><br> -->
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 text-center">
                                            ...
                                            <img src="<?php echo base_url('uploads/gambarDesain/'.$j[$i]->kodeGambar.'-d1.jpg')?>" class="img-responsive">
                                            <?php } ?>
                                        </div>
                                        <div class="col-lg-4 text-center">
                                            <b>Foto PIC</b><br><br>
