                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <table class="table1">
                                <tbody>
                                    <tr>
                                        <td style="width: 18%"><b>Berat Total</b></td>
                                        <td style="width: 5%">:</td>
                                        <td style="width: 10%"><?php echo $PO[0]->beratTotal;?></td>
                                     ...
                                     <tr>
                                        <td style="width: 18%"><b>Berat Batu</b></td>
                                        <td style="width: 5%">:</td>
                                        <td style="width: 10%"><?php echo $PO[0]->beratBatu;?></td>
                                        <td style="width: 10%">gram</td>
                                        <td style="width: 2%"></td>
                                        <td class="text-right" style="width: 15%"></td>
                                        <td class="text-right" style="width: 5%"></td>
                                     ...
                                     <tr>
                                        <td style="width: 18%"><b>Susut</b></td>
                                        <td style="width: 5%">:</td>
                                        <td style="width: 10%"><?php echo $PO[0]->susut;?></td>
                                        <td style="width: 10%">gram</td>
                                        <td style="width: 2%"></td>
                                        <td class="text-right" style="width: 15%"></td>
                                        <td class="text-right" style="width: 5%"></td>
                                     ...
                                     <tr>
                                        ...
                                        <td class="text-right" style="width: 15%">Rp <?php echo number_format($PO[0]->hargaAkhir,2,".","."); ?></td>
                                        <td class="text-right" style="width: 5%">=</td>
                                        <td class="text-right" style="width: 20%">Rp <?php echo number_format($PO[0]->beratHargaAkhir,2,".","."); ?></td>
                                     </tr>
                                     <tr>
                                        ...
                                        <td class="text-right" style="width: 15%"></td>
                                        <td class="text-right" style="width: 5%">=</td>
                                        <td class="text-right" style="width: 20%">Rp <?php echo number_format($PO[0]->upah,2,".",".");?></td>
                                     </tr>
                                     <tr>
                                        <td style="width: 18%"><b>Upah Pasang Berlian (pcs x Harga)</b></td>
                                        <td style="width: 5%">:</td>
                                        <td style="width: 10%"><?php echo $PO[0]->jumlahDatangBerlian;?></td>
                                        <td style="width: 10%">pcs</td>
                                        <td style="width: 2%">X</td>
                                        <td class="text-right" style="width: 15%">Rp <?php echo number_format($PO[0]->upahPasangBerlian,2,".","."); ?></td>
                                        <td class="text-right" style="width: 5%">=</td>
                                        <td class="text-right" style="width: 20%">Rp <?php echo number_format($PO[0]->jumlahDatangBerlian*$PO[0]->upahPasangBerlian,2,".",".");?></td>
                                     </tr>
                                     <tr>
                                        <td style="width: 18%"><b>CZ (pcs x Harga)</b></td>
                                        <td style="width: 5%">:</td>
                                        <td style="width: 10%"><?php echo $PO[0]->jumlahBatuZirkon;?></td>
                                        <td style="width: 10%">pcs</td>
                                        <td style="width: 5%"">X</td>
                                        <td class="text-right" style="width: 15%">Rp <?php echo number_format($PO[0]->hargaBatuZirkon,2,".","."); ?></td>
                                        <td class="text-right" style="width: 5%">=</td>
                                        <td class="text-right" style="width: 20%">Rp <?php echo number_format($PO[0]->jumlahBatuZirkon*$PO[0]->hargaBatuZirkon,2,".",".");?></td>
                                     </tr>
                                     <tr>
                                        ...
                                        <td class="text-right" style="width: 15%"></td>
                                        <td class="text-right" style="width: 5%">=</td>
                                        <td class="text-right" style="width: 20%">Rp <?php echo number_format($PO[0]->hargaKrumWarna,2,".","."); ?></td>
                                     </tr>
                                     <tr>
                                        <td style="width: 18%"></td>
                                        <td style="width: 5%"></td>
                                        ...
                                        <td class="text-right" style="width: 15%"></td>
                                        <td class="text-right" style="width: 5%"></td>
                                        <td class="text-right" style="width: 20%">_____________ +</td>
                                     </tr>
                                     <tr>
                                        <td style="width: 18%"></td>
                                        <td style="width: 1%"></td>
                                        ...
                                        <td style="width: 10%"></td>
                                        <td style="width :1%"></td>
                                        <td class="text-right" style="width: 10%">Rp <?php echo number_format($PO[0]->beratHargaAkhir+$PO[0]->upah+($PO[0]->jumlahDatangBerlian*$PO[0]->upahPasangBerlian)+($PO[0]->jumlahBatuZirkon*$PO[0]->hargaBatuZirkon)+$PO[0]->hargaKrumWarna,2,".","."); ?></td>
                                     </tr>
                                     <tr>
                                        <td style="width: 18%"><b>Datang Emas</b></td>
                                        <td style="width: 5%">:</td>
                                        <td style="width: 10%"><?php echo $PO[0]->datangEmas;?></td>
                                        <td style="width: 10%">gram</td>
                                        <td style="width: 2%">X</td>
                                        <td class="text-right" style="width: 15%">Rp <?php echo number_format($PO[0]->hargaDatangEmas,2,".","."); ?></td>
                                        <td class="text-right" style="width: 5%">=</td>
                                        <td class="text-right" style="width: 20%">Rp <?php echo number_format($PO[0]->datangEmas*$PO[0]->hargaDatangEmas,2,".",".");?></td>
                                     </tr>  
                                     <tr>
                                        ...
                                        <td class="text-right" style="width: 15%"></td>
                                        <td class="text-right" style="width: 5%">=</td>
                                        <td class="text-right" style="width: 20%">Rp <?php echo number_format($PO[0]->panjar,2,".",".");?></td>
                                     </tr>
                                     <tr>
                                        <td style="width: 18%"></td>
                                        <td style="width: 5%"></td>
                            ...
                            <table class="table1">
                                <tbody>
                                     <tr>
                                        ...
                                        <td class="text-right" style="width: 15%"></td>
                                        <td class="text-right" style="width: 5%">=</td>
                                        <td class="text-right" style="width: 20%"><b>Rp <?php echo number_format($PO[0]->beratHargaAkhir+$PO[0]->upah+($PO[0]->jumlahDatangBerlian*$PO[0]->upahPasangBerlian)+($PO[0]->jumlahBatuZirkon*$PO[0]->hargaBatuZirkon)+$PO[0]->hargaKrumWarna-($PO[0]->datangEmas*$PO[0]->hargaDatangEmas)-$PO[0]->panjar,2,".",".");?></b></td>
                                     </tr>
                                </tbody>
                            </table>
                    </div>
