                                ...
                                <table class="footable table table-stripped" data-page-size="15" data-filter=#filter>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" data-toggle="modal" data-target="#tambahCashflow" class="btn btn-xs btn-primary" >Tambah</a></td>
                                            <?php } else { ?>
                                          ...
                                          <div class="modal-dialog modal-md" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <?php echo form_open_multipart('user/editCashflow/'.$p->idCashflow)?>
