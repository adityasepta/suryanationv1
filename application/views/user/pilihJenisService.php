    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Purchase Order Service</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="col-md-4">
                    <a type="button" data-toggle="modal" data-target="#serviceSatuan">
                        <div class="ibox">
                            <div class="ibox-content product-box">
                                ...
                                <div class="product-desc">
                                    <h2 class="product-name text-center" style="font-size: 30px;"> Satuan</h2>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-4">
                    <a type="button" data-toggle="modal" data-target="#servicePartai">
                        <div class="ibox">
                            <div class="ibox-content product-box">
                                ...
                                <div class="product-desc">
                                    <h2 class="product-name text-center" style="font-size: 30px;"> Partai</h2>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <!-- Modal Service Partai-->
                <div class="modal inmodal fade" id="serviceSatuan" tabindex="-1" role="dialog"  aria-hidden="true">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                <h3 class="modal-title">Tipe Pelanggan</h3>
                                <span >PRODUKSI : <b class="text-success">SERVICE SATUAN</b></span>
                            </div>
                ...
                <!-- Modal Service Partai-->
                <div class="modal inmodal fade" id="servicePartai" tabindex="-1" role="dialog"  aria-hidden="true">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                <h3 class="modal-title">Tipe Pelanggan</h3>
                                <span >PRODUKSI : <b class="text-success">SERVICE PARTAI</b></span>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-sm-6 b-r">
                                        <?php echo form_open_multipart('user/createPOServicePartai','class="form-horizontal"')?>
                                        <h3 class="m-t-none m-b">Pelanggan Lama</h3>
                                        <p>Purchase Order dari pelanggan yang sudah pernah melakukan pembelian.</p>
                                        <div id="idCustomer" class="selectpicker" data-live="true">
                                            <button data-id="prov" type="button" class="btn btn-lg btn-block btn-default dropdown-toggle">
