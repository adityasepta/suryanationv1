                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <dir class="row">
                                <div class="col-lg-6">
                                    ...
                                    <?php if(count($dataPO) > 0) {?>
                                        <?php for ($i=0; $i < count($dataPO); $i++) {?>
                                            ...
                                            <?php if($dataPO[$i]->RealisasiEndDate != 0 ){ ?> 
                                                <?php 
                                                  $a=2;
                                            ...
                                            <?php } elseif($dataPO[$i]->RealisasiStartDate != 0) { ?>
                                                <?php 
                                                  $a=2;
                                                ...
                                                <div class="col-lg-5"><p><?php echo $tgljd?></p></div>
                                            <?php } else { ?>
                                                <div class="col-lg-5"><p>Menunggu Pengerjaan</p></div>
                                            <?php } ?>
                                ...
                                <?php } else { ?>
                                    <?php $d=count($dataPO); $e=$d-1; if($dataPO[$e]->idAktivitas == 1011 && $dataPO[$e]->statusWork == "Done") {?>
                                    <div class="col-lg-6">
                                        <p class="text-center"><em>Status PO</em></p>
                                        <div class="widget style1 navy-bg">
                                            <div class="row vertical-align">
                                                <div class="col-xs-12 text-center">
                                                    <p>Tanggal Selesai</p>
                                                    <p><strong><?php echo $dataPO[$e]->RealisasiEndDate;?></strong></p>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="widget style1 yellow-bg">
                                            <div class="row vertical-align">
                                                <div class="col-xs-12 text-center">
                                                    <p>Tanggal Estimasi Penyelesaian</p>
                                                    <?php 
                                                      $sls = new DateTime($dataUmum[0]->tanggalEstimasiPenyelesaian);
                                                      $tglsls = $sls->format("Y-M-d");
                                                    ?>
                                                    <p><strong><?php echo $tglsls;?></strong></p>
                                                    <h2 class="font-bold">On Progress</h2>
                                                </div>
                                            </div>
                                        </div>
