            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Buat Invoice Akhir PO Massal</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-sm-12 b-r">
                                        <?php echo form_open_multipart('user/convertInvoiceMassalPerseorangan','class="form-horizontal"')?>
                    ...
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-sm-12 b-r">
                                        <?php echo form_open_multipart('user/convertInvoiceMassalPertokoan','class="form-horizontal"')?>
                                        <h3 class="m-t-none m-b text-center">Nomor Purchase Order</h3>
