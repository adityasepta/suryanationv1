...
class mdl extends CI_Model {
    ...
    public function getBerat() {
        ...
        $sql = "SELECT f.idSPK, f.idAktivitas, a.namaAktivitas, SUM(f.berat) as berat, SUM(f.beratAwal) as beratAwal, SUM(f.kembali) as kembali  FROM factproduction f, aktivitas2 a WHERE f.idAktivitas = a.idAktivitas AND f.idAktivitas > 1002 GROUP BY idSPK,idAktivitas ORDER BY idSPK,idAktivitas";
        $query = $this->db->query($sql);
